  ...
  void _onItemTapped(int index) {
    ...
    switch (index) {
      case 0:
        break;
      case 1:
        Navigator.push(context, MaterialPageRoute(builder: (context) => GarageListPage()));
        break;
      case 2:
                ...
                ClipRRect(
                  ...
                  child: Image.network(
                    ...
                    errorBuilder: (context, error, stackTrace) =>
                        Icon(Icons.error, size: 150, color: AppColor.primary),
                  ),
                ),
                Padding(
    ...
    return Scaffold(
      ...
      body: GoogleMap(
        ...
        initialCameraPosition: CameraPosition(
          target: LatLng(-17.7224164393445, -83.175013515343366),
          zoom: 14.0,
        ),
